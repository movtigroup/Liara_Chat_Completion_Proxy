...
class CompletionRequest(BaseModel):
    ...
    messages: List[Message] = Field(..., description="لیست پیام‌های گفتگو")
    
    # پارامترهای مشترک
    max_tokens: Optional[int] = Field(None, gt=1, le=4096, description="حداکثر توکن خروجی")
...
class ChatCompletionResponse(BaseModel):
    ...
    object: str = Field(..., description="نوع شیء")
